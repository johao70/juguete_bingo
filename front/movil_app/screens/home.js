...
import { Image, Modal, Text, View, Alert, TextInput, FlatList, StyleSheet, ImageBackground } from 'react-native';
                ...
                <ImageBackground source={require('../assets/picks/bingo.png')} style={styles.imagen}>
                    <Header style={{backgroundColor: '#20575783'}}>
                        ...
                        <Body style={styles.navbar}>
                            <Image style={styles.user} source={require('../assets/player.png')} />
                            <Title style={styles.bingo}>Bingo</Title>
                            <Button rounded style={styles.position_logout} onPress={() => {this.props.navigation.push('Login')}}>
                                <Text>Salir</Text>
                    ...
                    <Button rounded style={styles.modal_position} onPress={() => { this.setModalVisible(!this.state.modalVisible)}}>
                        <Image style={{width: 50, height: 50}} source={require('../assets/modal.png')} />
                    </Button>
                </ImageBackground>
